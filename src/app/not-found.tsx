...
//       <img src="https://m.media-amazon.com/images/I/71N3o2SHmIL._AC_SL1500_.jpg" alt="Error Bro" width={200} className="border border-black border-2 m-4" />

//       <h1 className='text-red-600 text-xl m-4'>name: 'Ukulele'</h1>
//       <h1 className='text-red-600 text-xl m-4'>price: 1085</h1>
//       <h1 className='text-red-600 text-xl m-4'>id: 10</h1>
//       <h1 className='text-red-600 text-xl m-4'>price: 1085</h1>
